...
ADMIN_ID = ["945650098"]  # Replace with your admin user ID

# Replace with your Telegram bot token
bot = telebot.TeleBot('7251765685:AAHLFWFaTv4hWKGnEUpppTmkljyOt-nCqr4')
...
def handle_bgmi(message):
    ...
    # Send initial attack deployment message
...
🔥 **The wrath is unleashed. May the network shatter!** 🔥
    ...
    # Execute the attack command (non-blocking)
    ...
    # Function to edit the message after the attack duration
...
🔥 **Attack finished successfully!** 🔥
    ...
    # Schedule the final message after the attack duration without blocking
